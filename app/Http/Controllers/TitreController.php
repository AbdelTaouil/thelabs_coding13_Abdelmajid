...
class TitreController extends Controller
{
    ...
    public function indexbis()
    {
        ...
        return view('template.service', compact('titre' ,'tab','titres','logo','button','service','dataVIPD','dataVIPR','footer','servicepage','limite'));
    }
    public function indexbis2()
    {
        ...
        return view('template.blog', compact('titre','tag','categorie','article','tab','titres','logo','button','service','footer'));
    }
